...
// Variables
var databricksIntegration001Name = 'adb001-${uniqueName}-integration'
// var eventhubNamespaceIntegration001Name = '${prefix}-integration-eventhub001'
var datafactoryIntegration001Name = 'adf001-${uniqueName}-integration'
...
module datafactory001DatabricksRoleAssignment 'auxiliary/databricksRoleAssignment.bicep' = {
...
output datafactoryPrincipalId string = datafactoryIntegration001.outputs.datafactoryPrincipalId

output databricksIntegration001WorkspaceUrl string = databricksIntegration001.outputs.databricksWorkspaceUrl
